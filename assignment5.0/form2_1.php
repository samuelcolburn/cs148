                    ...
                    <fieldset class="contact">
                        ...
                        <label for="txtStart">Start Time
                            <input type="text" id="txtStart" name="txtStart"
                                   ...
                                   tabindex="100" maxlength="45" placeholder="Enter class start time like: 12:50"
...
<option value='AIKEN'>AIKEN</option> 
                        ...
                        <label for="txtDepartment">Department
                            <input type="text" id="txtDepartment" name="txtDepartment"
                                   ...
                                   tabindex="300" maxlength="45" placeholder="Enter a Department"
                                   <?php if ($DepartmentERROR) print 'class="mistake"'; ?>
                                   >
                        </label>
                        <label for="txtCourseNumber">Course Number
                            <input type="text" id="txtDepartment" name="txtCourseNumber"
                                   value="<?php print $CourseNumber; ?>"
                                   tabindex="400" maxlength="45" placeholder="Enter a Course Number like: 148"
                                   <?php if ($CourseNumberERROR) print 'class="mistake"'; ?>
                                   >
                        </label>

                        <label for="txtLastName">Professor
                            <input type="text" id="txtDepartment" name="txtLastName"
                                   value="<?php print $LastName; ?>"
                                   tabindex="500" maxlength="45" placeholder="Enter a professor last name like: Erickson"
